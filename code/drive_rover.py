...
ground_truth = mpimg.imread('C:/ProgramData/Anaconda3/RoboND-Python-StarterKit/RoboND-Rover-Project-master/RoboND-Rover-Project-master/calibration_images/map_bw.png')
